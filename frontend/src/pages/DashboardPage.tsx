    ...
    return (
      <div className="page-stack">
        ...
        <div className="card dashboard-game-card">
          <h3>Game Mode</h3>
          {gameLoading ? (
            <div style={{ textAlign: "center", padding: 12 }}>Loading Game Mode…</div>
          ) : gameSummary ? (
            <>
              ...
              >
                <div className="dashboard-game-stat">
                  ...
                  <strong className="dashboard-game-stat-value">{gameSummary.streak} 🔥</strong>
                </div>
                <div className="dashboard-game-stat">
                ...
                <div className="dashboard-game-stat">
                  ...
                  <strong className="dashboard-game-stat-value">
                    {gameSummary.piecesThisPhase}/{gameSummary.phaseTotal} 🧩
                  </strong>
                </div>
              </div>
            ...
            <p style={{ color: "var(--color-text-muted)" }}>Game progress unavailable. Open Game Mode once while logged in.</p>
          )}
        </div>
        ...
        {!statsLoading && !exerciseStats && !statsError && (
          <div className="card" style={{ textAlign: "center", color: "var(--color-text-muted)" }}>
            <p>No exercise data yet. Go to <strong>Exercises</strong> to get started! 🚀</p>
          </div>
        )}
      </div>
    );
