...
export function FillBlankExercise({ exercise, onSubmit }: ExerciseProps) {
  const prompt = exercise.content?.prompt ?? "Fill in the blank.";
  ...
  return (
    <ExerciseShell title="Fill the blank" prompt={prompt}>
